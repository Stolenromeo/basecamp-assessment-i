...
// CODE HERE
var trueFaveNum = 4;
if (trueFaveNum===faveNum){return true};
...
if (myName != notHakeem){return true}
else (myName !='Karl Malone'){return true};
...
function sum (num1){return num1+=num1}
...
function greeter (myName, myAge){
 ...
 string2 = 'and I am ';
 string3 = ' years old';
console.log(string1+myName+string2+myAge+string3)  
}
